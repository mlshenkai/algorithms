...
def resnest50_fast_2s1x64d(pretrained=False, root="~/.encoding/models", **kwargs):
    ...
    if pretrained:
        model.load_state_dict(
            torch.hub.load_state_dict_from_url(
                resnest_model_urls["resnest50_fast_2s1x64d"],
                progress=True,
                check_hash=True,
            )
        )
...
def resnest50_fast_4s1x64d(pretrained=False, root="~/.encoding/models", **kwargs):
    ...
    if pretrained:
        model.load_state_dict(
            torch.hub.load_state_dict_from_url(
                resnest_model_urls["resnest50_fast_4s1x64d"],
                progress=True,
                check_hash=True,
            )
        )
...
def resnest50_fast_1s2x40d(pretrained=False, root="~/.encoding/models", **kwargs):
    ...
    if pretrained:
        model.load_state_dict(
            torch.hub.load_state_dict_from_url(
                resnest_model_urls["resnest50_fast_1s2x40d"],
                progress=True,
                check_hash=True,
            )
        )
...
def resnest50_fast_4s2x40d(pretrained=False, root="~/.encoding/models", **kwargs):
    ...
    if pretrained:
        model.load_state_dict(
            torch.hub.load_state_dict_from_url(
                resnest_model_urls["resnest50_fast_4s2x40d"],
                progress=True,
                check_hash=True,
            )
        )
...
def resnest50_fast_1s4x24d(pretrained=False, root="~/.encoding/models", **kwargs):
    ...
    if pretrained:
        model.load_state_dict(
            torch.hub.load_state_dict_from_url(
                resnest_model_urls["resnest50_fast_1s4x24d"],
                progress=True,
                check_hash=True,
            )
        )
