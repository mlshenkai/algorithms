...
from algorithm.ocr.text_ocr.data.imaug.iaa_augment import IaaAugment
from algorithm.ocr.text_ocr.data.imaug.random_crop_data import is_poly_outside_rect
