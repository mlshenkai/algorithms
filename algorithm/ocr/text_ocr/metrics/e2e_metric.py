...
from algorithm.ocr.text_ocr.utils.e2e_metric.Deteval import get_socre_A, get_socre_B, combine_results
from algorithm.ocr.text_ocr.utils.e2e_utils.extract_textpoint_slow import get_dict
